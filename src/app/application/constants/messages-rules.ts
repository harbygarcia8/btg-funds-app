...
export const DONT_HAVE_SUSCRIPTION_ACTIVE_FOR_THIS_FUND_MESSAGE =
  'No tiene una suscripción activa para este fondo.';
export const SUSCRIPTION_CANCELLED_MESSAGE =
  'La suscripción ha sido cancelada con éxito. El dinero ha sido devuelto a tu cuenta.';
